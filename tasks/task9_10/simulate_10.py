...
def jacobi_old(u, interior_mask, max_iter, atol=1e-6):
    u = cp.copy(u)
...
def jacobi_new(u, interior_mask, max_iter, atol=1e-6):
    u = cp.copy(u)
...
if __name__ == '__main__':
    ...
    #     u = jacobi_old(u0, interior_mask, MAX_ITER, ABS_TOL)
    #     all_u[i] = u

    # all_u_new = jacobi_new(all_u0, all_interior_mask, MAX_ITER, ABS_TOL)
    # print(all_u == all_u_new)
    all_u = jacobi_new(all_u0, all_interior_mask, MAX_ITER, ABS_TOL)
